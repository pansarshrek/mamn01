 ...
 * 
 */
public class ARELFragmentActivity extends ARViewFragmentActivity {
	...
	public void onSurfaceCreated() {
		...
		if (mGestureHandler == null) {
			...
			mGestureHandler = new GestureHandlerAndroid(metaioSDK, GestureHandler.GESTURE_ALL, mWebView, mSurfaceFragment.getSurfaceView());
			mARELInterpreter.initialize(metaioSDK, mGestureHandler);
		} else {
			// Update reference to the GLSurfaceView
			mGestureHandler.setGLSurfaceView(mSurfaceFragment.getSurfaceView());
		}
	}
