...
public abstract class SensorFusion extends FragmentActivity implements
	...
	/*
	 * Abstrakta metoder som behövs implementeras.
	 */
	// Denna metoden körs när programmet har räknat ut en ny position.
	...
	/*
	 * Detta är kod från sersorfusion
	 */
	...
	private void sensorFusionOnCreate() {
		/*
		 * Sätter upp saker som behövs för sensor fusion
		 */
